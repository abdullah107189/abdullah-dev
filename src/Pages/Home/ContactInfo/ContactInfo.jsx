        ...
        <div className="">
            ...
            <div className="grid dark:text-white grid-cols-1 md:grid-cols-2 gap-6 md:p-6 p-3 rounded-2xl border dark:border-gray-700 shadow-lg mb-5">
                ...
                <div className="bg-gray-100 dark:bg-transparent border dark:border-gray-700 md:p-6 p-4 rounded-lg shadow-lg ">
                    <h3 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Contact Details</h3>
                    ...
                    <div className='flex items-center flex-col justify-center'>
                        ...
                        <div className="mb-6">
                            ...
                            <a href={`tel:${phoneNumber}`} className="flex items-center gap-3 text-blue-500 bg-blue-300/20 p-3 border rounded-lg hover:bg-blue-200 transition duration-300">
                                <FaPhoneAlt className="h-6 w-6 text-blue-600" />
                                {phoneNumber}
                            </a>
                        </div>
                        <div className="mb-6">
                            <h4 className="text-lg mb-3 font-semibold text-center">WhatsUp</h4>
                            <a href={`https://wa.me/${whatsappNumber}`} className="flex items-center gap-3 text-blue-500 bg-blue-300/20 p-3 border rounded-lg hover:bg-blue-200 transition duration-300">
                        ...
                        <div className="mb-6">
                            <h4 className="text-lg mb-3 font-semibold text-center">Location</h4>
