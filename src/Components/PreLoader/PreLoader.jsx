const Preloader = () => (
  <div className="h-screen flex flex-col justify-center items-center  bg-[#1d232a] overflow-hidden">
    ...
    <h2 className="mt-4 text-xl sm:text-3xl font-mono animate-typing overflow-hidden border-r-4 border-green-400 whitespace-nowrap"></h2>
