const Footer = () => {
    return (
        <footer className="bg-[#f6fbec] text-gray-800 py-12">
            <div className="max-w-7xl mx-auto flex flex-wrap gap-10 justify-between px-4">
                {/* About Section */}
                <div className="flex-1 min-w-[200px]">
                    <h3 className="text-xl font-semibold text-[#60f318] mb-4">About Me</h3>
                    <p className="text-sm">
                ...
                {/* Quick Links Section */}
                <div className="flex-1 min-w-[200px]">
                    <h3 className="text-xl font-semibold text-[#60f318] mb-4">Quick Links</h3>
                ...
                {/* Services Section */}
                <div className="flex-1 min-w-[200px]">
                    <h3 className="text-xl font-semibold text-[#60f318] mb-4">Services</h3>
                    <ul className="space-y-2 text-sm">
                ...
                <div className="flex-1 min-w-[200px]">
                    <h3 className="text-xl font-semibold text-[#60f318] mb-4">
                        Follow Me
                    </h3>
